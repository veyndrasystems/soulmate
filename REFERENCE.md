...
The v0.14.0-rc.2 candidate targets Linux x86_64 and native macOS on Apple
...
```sh
curl -fsSL https://raw.githubusercontent.com/veyndrasystems/soulmate/v0.14.0-rc.2/install.sh | SOULMATE_VERSION=v0.14.0-rc.2 sh
...
before this feature cannot self-notify, so install `0.14.0-rc.2` once to enable
...
```text
dotagents --project add veyndrasystems/soulmate --ref v0.14.0-rc.2
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/veyndrasystems/soulmate/v0.14.0-rc.2/schema/harness-manifest.schema.json",
  "version": 1,
